...
try:
    ...
    class KNN(nn.Module):
        ...
        def forward(self, ref, query):
            # ref: (B, N, C), query: (B, M, C) when transpose_mode=True
            ...
            knn_dists, idx = torch.topk(dists, k=self.k, dim=-1, largest=False, sorted=True)
            return knn_dists, idx
...
class Encoder(nn.Module):  ## Embedding module
    def __init__(self, encoder_channel, input_channel = 3):
        super().__init__()
